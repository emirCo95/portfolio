  ...
  return (
    <div className="w-full flex flex-col justify-evenly items-center overflow-hidden bg-no-repeat bg-cover bg-center h-full bg-[url('/experience.jpg')]">
      ...
      <div className="w-full flex flex-col md:flex-row justify-evenly items-center mt-10 mb-10 z-0">
        <div className="z-10 w-full h-[350px] md:h-[300px] flex flex-col md:flex-row justify-evenly items-center bg-teaGreen shadow-md transition duration-500 hover:scale-110 backdrop-filter backdrop-blur-md bg-opacity-90">
      ...
      <div className="w-full flex flex-col md:flex-row justify-evenly items-center mt-10 mb-10 z-0">
        <div className="z-10 w-full h-[350px] md:h-[300px] flex flex-col md:flex-row justify-evenly items-center bg-teaGreen shadow-md transition duration-500 hover:scale-110 backdrop-filter backdrop-blur-md bg-opacity-90">
          ...
          <div className="text-center">
            ...
            <h3>MS in Software Engineering</h3>
            <h4>2022 - 2025</h4>
          </div>
        </div>
      </div>
